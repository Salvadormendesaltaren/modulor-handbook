...
|---------|-----------|--------|
| **Full** | Completo: financieros, pricing, equipos, estrategia | Leadership |
| **Lite** | Resumen ejecutivo con datos sensibles | Leadership |
| **Team** | Operativo: sin datos sensibles | Todo el grupo |
