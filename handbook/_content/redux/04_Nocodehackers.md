...
- **Rol en Modulor:** Exploradores de la frontera entre IA y desarrollo de producto

### Posicionamiento

- **¿Qué somos?** Academia de formación no-code/IA + Agencia de desarrollo
- **¿Para quién?**
    - **Educación:** Freelancers, aspirantes a freelancers, makers
    - **Agencia:** Empresas y startups que necesitan webs, MVPs o automatizaciones
- **¿Qué nos hace diferentes?**
    - Exploradores de Lovable y Vibe Coding al límite
    - Únicos haciendo Vibe Coding para proyectos reales
...
| --- | --- |
| Curso de VibeCoding | IA + prototipado |
| Experto en Automatizaciones | Make |
| Experto en Desarrollo Web | Framer |
| No-code Specialist (1 año) | Programa completo |
| Experto en Desarrollo de Apps | FlutterFlow |
| Experto en Operaciones con IA | Airtable |

#### Formación In-Company

- Formación para equipos de empresas en No-code, IA y automatizaciones
...
- Sistemas de gestión internos con Airtable + Make

#### MVPs y Validación de Ideas

- Desarrollo rápido de productos mínimos viables con Bubble, Webflow, Make, n8n

#### Desarrollo de Apps Móviles

- Apps nativas sin código con FlutterFlow + Supabase

#### Diseño y Desarrollo Web

- Webs profesionales rápidas con Framer

#### Automatizaciones

- Automatización de procesos repetitivos con Make, Zapier, n8n
...
- **Iberia** — Sistema de gestión de reservas (Espacio Iberia en México)
- **Santalucía** — Programa de MVPs de 3 meses (múltiples MVPs validados)
- **Wend** — App construida en 18 días, Top 7 App Store, 250k solicitudes/día (FlutterFlow)
- **SpainFreeTours** — Automatización de +200,000 free tours/año (Make, Airtable)
...
- **Nocodehackers + Tailor Hub:** MVP no-code → desarrollo custom posterior
